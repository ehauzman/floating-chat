            ...
            <div className="app__group-grid">
              ...
              <label>
                ...
                <input
                  ...
                  value={responseDelay}
                  onChange={(event) =>
                    setResponseDelay(Number(event.target.value) || 0)
                  }
                />
              </label>
            </div>
        ...
        <div className="app__props-column">
            ...
            <div className="app__group-grid">
              <label>
                ...
                <select
                  ...
                  onChange={(event) =>
                    setAvatarType(
                      event.target.value as TDemoConfig["avatarType"],
                    )
                  }
                >
              ...
              {avatarType !== "image" && (
                <label>
                  ...
                  <input
                    ...
                    placeholder={avatarType === "emoji" ? "💬" : "Chat"}
                  />
                </label>
              )}
          ...
          <section className="app__group">
            ...
            <div className="app__actions">
              ...
              <button type="button" onClick={() => applyConfig(DEFAULT_CONFIG)}>
                Reset
              </button>
            </div>
            ...
            <div className="app__group-grid">
              <label>
                ...
                <input
                  ...
                  value={size}
                  onChange={(event) =>
                    setSize(Number(event.target.value) || 60)
                  }
                />
              </label>
            </div>
